...
const indexLaunch = () => {
  ...
  tl.to('.intro-wrapper', { duration: 2, scaleY: 0, ease: 'power4.inOut' })
    .fromTo('nav a', { y: '60%', autoAlpha: 0 }, { autoAlpha: 1, y: '0%', duration: 2, ease: 'power4.out', stagger: 0.2 }, '-=1.5')
    .fromTo('.logo', { y: '60%', autoAlpha: 0 }, { autoAlpha: 1, y: '0%', duration: 2, ease: 'power4.out', stagger: 0.2 }, '-=1.5')
